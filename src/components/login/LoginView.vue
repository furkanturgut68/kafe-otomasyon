<template>
  <div class="w-full h-screen flex justify-content-center align-items-center surface-400">
      <div class="flex flex-column w-4 h-auto bg-white border-round-sm">
                 <div class="m-4 flex flex-column gap-2">
                   ...
                   <PvInputText type="email" v-model="emailAdress" class="col-12"/>
...
export default {
  ...
  watch(
    ...
    return { selectUser, userType, emailAdress, password, login, inputDisabledController }
  }
